...
class TestSubmissionFile(TestCase):
    ...
    def test_create_submission_file(self):
        ...
        self.assertEqual(self.submission_file.submission_queue, self.external_grader_detail)
    ...
    def test_xqueue_url_format(self):
        ...
        expected_url = f"/{self.external_grader_detail.queue_name}/{self.submission_file.uid}"
